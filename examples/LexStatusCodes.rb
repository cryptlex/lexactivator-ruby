module LexStatusCodes
  ...
  # CODE: LA_E_WMIC
  # MESSAGE: Fingerprint could not be generated because Windows Management
  ...
  # MESSAGE: The license has reached the allowed activations limit.
  ...
  # MESSAGE: The license has reached the allowed deactivations limit.
  ...
  # MESSAGE: Your account has reached the trial activations limit.
  ...
  # MESSAGE: The license has reached the metadata fields limit.
  LA_E_ACTIVATION_METADATA_LIMIT = 66

  # CODE: LA_E_TRIAL_ACTIVATION_METADATA_LIMIT
  # MESSAGE: The trial has reached the metadata fields limit.
